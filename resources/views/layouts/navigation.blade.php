    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:bg-gray-700 focus:outline-none focus:bg-gray-100 dark:bg-gray-700 focus:text-gray-500 transition duration-150 ease-in-out">
        ...
        @else
            <div class="pt-2 pb-3 space-y-1">
                <div class="px-4">
                    ...
                    <div class="mt-3 space-y-1">
                        <a href="{{ route('login') }}" class="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 dark:bg-gray-700">Login</a>
                        <a href="{{ route('register') }}" class="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 dark:bg-gray-700">Register</a>
                    </div>
                </div>
            </div>
        @endauth
