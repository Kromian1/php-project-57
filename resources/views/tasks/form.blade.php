...
<div class="space-y-6">
    ...
    <div>
        {{ html()->label(__('Status'), 'status_id')->class('block text-gray-700 font-bold mb-2') }}
    ...
    <div>
        {{ html()->label(__('Executor'), 'assigned_to_id')->class('block text-gray-700 font-bold mb-2') }}
    ...
    <div>
        {{ html()->label(__('Labels'), 'labels')->class('block text-gray-700 font-bold mb-3') }}
